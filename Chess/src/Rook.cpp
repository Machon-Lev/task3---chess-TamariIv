...
//
//bool Rook::isValidMove(int curr_row, int curr_col, int row, int col, Piece* const(&board)[21][21]) const
//{
...
//	if (curr_col < col) {
//		for (size_t i = curr_col + 1; i < col; i++)
//		{
...
//		for (size_t i = curr_row + 1; i < row; i++)
//		{
...
Rook::Rook(bool _color) : 
	Piece(_color ? 'R' : 'r', _color)
{}
